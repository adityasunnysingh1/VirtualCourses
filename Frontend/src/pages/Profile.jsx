...
function Profile() {
  ...
  return (
    <div className="relative min-h-screen px-4 py-10 flex items-center justify-center bg-black overflow-hidden">
      ...
      {/* CARD CONTAINER: Relative + Overflow Hidden (Keeps animation inside) */}
      <div className="relative z-10 bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rounded-2xl max-w-xl w-full text-white overflow-hidden">
        
        {/* 1. BACKGROUND LAYER (Absolute, sits at the back) */}
