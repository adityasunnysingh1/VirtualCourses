...
/**
 * -----------------------------------------------------
 * GLOBAL VARIABLES & HELPERS (Moved outside Component)
 * -----------------------------------------------------
 */
...
/**
 * -----------------------------------------------------
 * CLASS DEFINITIONS (Moved outside Component)
 * -----------------------------------------------------
 */
...
class Simulation {
  constructor(options, paletteTex, bgVec4) {
    this.options = {
...
class Output {
  ...
  init() {
    this.simulation = new Simulation({}, this.paletteTex, this.bgVec4);
    this.scene = new THREE.Scene();
    this.camera = new THREE.Camera();
...
export default function LiquidEther({
  ...
  resolution = 0.5,
  isBounce = false,
  colors = ['#FFFFFF', '#F3F4F6', '#E0F2FE'], // Default White Theme
  style = {},
  className = '',
  autoDemo = true,
  autoSpeed = 0.5,
  ...
  useEffect(() => {
    ...
    // Initialize Global State classes
  ...
  useEffect(() => {
    ...
    // Note: Changing 'colors' dynamically requires regenerating texture, 
    // which is expensive and not implemented in this hot-update loop for performance.
