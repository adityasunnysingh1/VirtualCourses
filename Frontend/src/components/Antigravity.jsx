...
const AntigravityInner = ({
  ...
  // This holds the data without triggering re-renders.
  const particles = useRef([]);

  // Populate the ref inside useEffect.
  useEffect(() => {
    const temp = [];
    ...
    // Assign directly to ref.current (no re-render triggered)
    particles.current = temp;
  }, [count, viewport.width, viewport.height]);

  useFrame(state => {
    const mesh = meshRef.current;
    // Check particles.current instead of state
    ...
    // Loop through particles.current
