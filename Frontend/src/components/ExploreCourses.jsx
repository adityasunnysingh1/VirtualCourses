...
function ExploreCourses() {
  ...
  return (
    <Antigravity 
      ...
      magnetRadius={20}      
      particleSize={1.5}     
      className="w-full min-h-[50vh] lg:h-[50vh]" 
    >
      <div
        className="w-full h-full flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]"
      >
        {/* left/top div */}
        <div
        ...
        {/* right/bottom div (Grid of Icons) */}
        <div className="w-[720px] max-w-[90%] lg:h-[300px] md:min-h-[300px] 
          ...
          <div className="w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center">
            <div className="w-[100px] h-[90px] bg-[#9bea94] rounded-lg flex items-center justify-center">
          ...
          <div className="w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center">
            <div className="w-[100px] h-[90px] bg-[#254f92] rounded-lg flex items-center justify-center">
